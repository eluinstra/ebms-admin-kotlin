...
private fun FormLayout.messageFields(message: EbMSMessage) {
    with(message) {
        addFormItem(text(messageId), getTranslation("lbl.messageId"))
        addFormItem(text(messageNr.toString()), getTranslation("lbl.messageNr"))
...
fun FormLayout.deliveryTasks(deliveryTask: DeliveryTask): Component =
    verticalLayout {
...
fun FormLayout.deliveryLogs(deliveryLogs: List<DeliveryLog>): Component =
    verticalLayout {
        setColspan(this, 2) //
...
fun FormLayout.attachments(attachments: List<EbMSAttachment>): Component =
    verticalLayout {
        setColspan(this, 2) //
